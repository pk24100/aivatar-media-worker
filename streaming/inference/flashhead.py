...
class FlashHeadStreamingEngine:
    ...
    def __init__(
        ...
        self._metrics_upscale_total_ms = 0.0
    ...
    def _process_available_audio(self):
        ...
        while len(self.pending_audio) >= self.slice_samples:
            ...
            _upscale_ms = (time.monotonic() - _t_upscale) * 1000
            ...
            logger.info(
                ...
                "infer=%.1fms xfer=%.1fms (upscale=%.1fms) total=%.1fms",
                _deque_ms, _ctx_ms, _embed_ms, _infer_ms, _xfer_ms, _upscale_ms, _total_ms,
            )
            ...
            self._metrics_upscale_total_ms += _upscale_ms
            self._log_metrics()
