...
image = (
    ...
    # Multi-arch build supporting all test GPUs:
    # 8.0=A100, 8.6=A10, 8.9=L40S/L4, 9.0=H100/H200, 10.0=B200, 12.0=RTX PRO 6000
    ...
    .run_commands(
        "TORCH_CUDA_ARCH_LIST='8.0 8.6 8.9 9.0 10.0 12.0' MAX_JOBS=8 NVCC_THREADS=4 "
